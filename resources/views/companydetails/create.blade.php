                ...
                <form action="{{ route('companydetails.store') }}" method="POST">
                    ...
                    <div class="form-floating mb-4" >
                        <input type="text" class="form-control" id="Companyname" placeholder="Company Name"
                            name="Companyname" value="{{Auth::user()->Companyname}}" style="height:50px; font-size:15px">
                        <label for="Companyname">Company Name</label>
                    </div>

                    <div class="form-floating mb-4" >
                        <input type="text" class="form-control" id="Companycode" placeholder="Company Code"
                            name="Companycode" value="{{Auth::user()->Companycode}}" style="height:50px; font-size:15px">
                        <label for="Companycode">  Company Code</label>
                    </div>
                    <div class="form-floating mb-4">
                        <input type="text" class="form-control" id="Companyaddress" placeholder="Company Address"
                            name="Companyaddress" style="height:50px; font-size:15px">
                        <label for="Companyaddress">Company Address </label>
                    </div>
                  
                    <div class="form-floating mb-4" >
                        <input type="number" class="form-control" id="TotalEmployes" placeholder="Total Number OfEmployes"
                            name="TotalEmployes" style="height:50px; font-size:15px">
                        <label for="TotalEmployes"> Total Number Of Employes </label>
                    </div>
                    <div class="form-floating mb-4">
                    ...
                    <div class="form-floating mb-4">
                        <input type="date" class="form-control" id="CreatedDate" placeholder="Created Date"
                            name="CreatedDate" style="height:50px; font-size:15px">
